...
const translations = {
  en: {
    ...
    features: [
      "Real-time bus tracking to reduce wait times",
      "Smart trip scheduling with suggested departure windows",
      "Live service alerts for delays, diversions, and closures",
      "Offline-ready PWA for low connectivity conditions",
      "Crowding-aware demand predictions (AI-assisted)",
    ],
  ...
  am: {
    ...
    features: [
      "የባስ እንቅስቃሴን በእውነተኛ ጊዜ መመልከት",
      "አስተካክሎ የጊዜ ሰሌዳ ጥቆማ እና ምክር",
      "ስለ መዘግየት፣ መሻር እና መዘግየት ማስታወቂያዎች",
      "በዝቅተኛ ኢንተርኔት ሁኔታ የሚሰራ የPWA ዝግጁነት",
      "በአብዛኛው ጊዜ ተጭነት በመመከት የAI ትንታኔ",
    ],
  ...
  om: {
    ...
    features: [
      "Bussiwwan yeroo dhugaa hordofuu (yeroo eeggannoo xiqqeessuuf)",
      "Tartiiba imalaa ogummaa qabu fi yaadannoo yeroo deemsisa",
      "Oduu tajaajila (tuffii, jijjiirraa, cufamuu) yeroo dhugaa",
      "PWA sirrii sababa qunnamtii gadi-aanaa irrattis ni hojjetti",
      "Tuma’ina baay’ina imaltootaa (AI tajaajilaan)",
    ],
  ...
  ti: {
    ...
    features: [
      "ናይ ንቡስ እንቅስቃሴ እቲ ኣብ ሕጂ ግዜ ምርካብ",
      "ግዜ ሰሌዳ ብምትካከል ኣብ ምድላው ምክር",
      "ንመዘግየት/ምሻር/ምዝጋብ ሓበሬታታት ኣብ ሕጂ ግዜ",
      "PWA ምዕባለ እና ናይ ብቕልጡፍ መስመር ስርሕ ዝሓለፈ",
      "ብAI ትንተና ናይ ተመራማሪ ዝርከብ ብዝሒ ተጓዥቲ",
    ],
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="flex items-center gap-3 mt-3 mb-4">
                <img src="/transitlogo.png" alt="AddisTransit logo" className="h-36 w-36 rounded-lg shadow-sm" />
                <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight m-0">{t.heroTitle}</h1>
              </div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a href="/about" className="px-5 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-white/80 dark:bg-gray-900/60 hover:bg-white text-gray-900 dark:text-gray-100 font-medium shadow-sm">
                  Learn More
                </a>
              </div>
            </div>
            <div className="relative hidden md:block">
              ...
              <div className="relative rounded-3xl border border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/60 p-6 shadow-xl">
                <div className="grid grid-cols-2 gap-4">
                  <FeatureCard icon={<Route className="h-5 w-5" />} title="Real-time Tracking">
                    Live bus locations to reduce wait times
                  </FeatureCard>
                  <FeatureCard icon={<Smartphone className="h-5 w-5" />} title="Smart Scheduling">
                    Suggested departure windows based on demand
                  </FeatureCard>
                  <FeatureCard icon={<HelpCircle className="h-5 w-5" />} title="Service Alerts">
                    Delays, diversions, and closures in real time
                  </FeatureCard>
                  <FeatureCard icon={<Languages className="h-5 w-5" />} title="Offline-ready PWA">
                    Works great on low connectivity and installs to home screen
                  </FeatureCard>
                </div>
              </div>
            </div>
